...
from shaders import BaseShaderProgram,BlinnShader, FlatShader
from environmentMapping import EnvironmentShader
...
class ShadowMappingShader(BlinnShader):
    def __init__(self, shadow_map=None):
        BlinnShader.__init__(self, name='shadow_mapping')
